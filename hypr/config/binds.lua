...
hl.bind(mainMod .. " + I",           hl.dsp.window.fullscreen({ mode = 1 }))
...
hl.bind(mainMod .. " + 4", hl.dsp.focus({ monitor = MONITOR3 }))
hl.bind(mainMod .. " + 5", hl.dsp.focus({ monitor = MONITOR3 }))
hl.bind(mainMod .. " + 6", hl.dsp.focus({ monitor = MONITOR3 }))
hl.bind(mainMod .. " + 7", hl.dsp.focus({ monitor = MONITOR3 }))
hl.bind(mainMod .. " + 8", hl.dsp.focus({ monitor = MONITOR3 }))
hl.bind(mainMod .. " + 9", hl.dsp.focus({ monitor = MONITOR3 }))
-- Focus on workspace number
-- Absolute
for i = 1, NUM_WPM do
    local key = i % 10
    hl.bind(mainMod .. " + g  + " .. key, hl.dsp.focus({ workspace = i }))
end
-- Relative
for i = 1, NUM_WPM do
    local key = i % 10
